...
# PROCESS (SJF - SimPy)
# ======================
def process(env, name, cpu, burst, arrival, y):
...
def run_simulation():
    ...
    for i, row in enumerate(entries):
        try:
            ...
            priority = int(row[3].get())  # belum dipakai di SJF
...
# ======================
root = tk.Tk()
root.title("SJF Scheduling (SimPy + Full Input)")
root.geometry("950x650")

tk.Label(root, text="CPU Scheduling - SJF (SimPy)", font=("Arial", 16)).pack(pady=5)
